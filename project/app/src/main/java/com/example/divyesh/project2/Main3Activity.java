...
public class Main3Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySelectedScreen(R.id.nav_upload_material);
    }
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_upload_material:
                fragment = new Material_Upload_Table();
                break;
            case R.id.nav_working_schedule:
                fragment = new Working_Schedule_Table();
                break;
